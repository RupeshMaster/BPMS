...
export const AdminDashboard = ({ userSession, onLogout, isSidebarOpen, setIsSidebarOpen }) => {
            ...
            <div className="w-full h-[15.625rem]">
              <ResponsiveContainer width="100%" height="100%" minWidth={1} minHeight={1}>
                <AreaChart data={trendData}>
                  ...
                  <Area type="monotone" dataKey="Revenue" stroke="#0066CC" fillOpacity={1} fill="url(#colorRev)" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </div>
      ...
      >
        <div className="panel-card max-w-[32rem] mx-auto rounded-xl p-8 border border-slate-200 shadow-lg">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', fontSize: '1rem' }}>
            ...
            <div style={{ borderBottom: '1px solid var(--border-gray)', paddingBottom: '0.9375rem' }}>
              <strong>Role Permission:</strong> <span style={{ color: 'var(--bp-blue)', fontWeight: 700 }}>Station Manager</span>
            </div>
            <div style={{ borderBottom: '1px solid var(--border-gray)', paddingBottom: '0.9375rem' }}>
